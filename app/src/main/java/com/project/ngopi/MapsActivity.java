...
public class MapsActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private String API_KEY_SERVER = "AIzaSyDQUYL50oKT3iVK_UrJqleYYUAeZvfG3ag";
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<HashMap<String, String>>> {
        ...
        protected void onPostExecute(List<HashMap<String, String>> list) {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                String buka = hmPlace.get("opening_hours");


                LatLng latLng = new LatLng(lat, lng);

                markerOptions.position(latLng);
                markerOptions.title(nama + " : " + namaJln + " : " + buka);
            ...
            Toast.makeText(MapsActivity.this, "Menemukan " + totalToko + " Coffee Shop", Toast.LENGTH_LONG).show();
        }
